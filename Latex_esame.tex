...
\begin{frame}{Visualizzazione SWIR}
 \includegraphics[width=\textwidth, height= \textheight]{Immagini/Dadia_SWIR.pdf}
    \centering
    \end{frame}
...
\begin{frame}{Visualizzazione DVI}
    \includegraphics[width= \textwidth]{DVI.pdf}
\end{frame}
...
\begin{frame}{Visualizzazione NDVI}
    \includegraphics[width=\textwidth]{Immagini/NDVI.pdf}
\end{frame}

\begin{frame}{Differenza NDVI 22-23}
\includegraphics[width=0.90\textwidth, height=\textheight]{Immagini/Differenza NDVI.pdf}
\centering
    \end{frame}

\begin{frame}{Differenza NDVI pre-post incendio}
    \includegraphics[width=0.90\textwidth, height=\textheight]{Immagini/Differenza NDVI prepost.pdf}
    \centering
\end{frame}

\begin{frame}{Differenza NDVI totale}
\includegraphics[width=0.9\textwidth, height=\textheight]{Immagini/Differenza NDVI tot.pdf}
\centering
    \end{frame}
...
\includegraphics[width=\textwidth]{Immagini/Grafico_coperturasuolo.pdf}
\end{frame}
...
\begin{frame}{Discussione}
    \begin{itemize}
        ...
        \item Tuttavia i danni causati dall'incendio del 26 Agosto 2023 sono stati molto più ingenti di quelli passati, causando la perdita di circa il 50% della copertura forestale dell'area del Parco.
